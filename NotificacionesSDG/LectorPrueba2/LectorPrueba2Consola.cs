...
{
    string valorLeido;
    Lector lector = new Lector { Nombre = "Lector 2" };
    ...
    do
    {
        Console.WriteLine("[*] Lector 2. ¿Desea suscribirse? [y,n] y presione enter en cualquier momento:");
        ...
        if(valorLeido == "y")
        {
            ...
            Console.WriteLine("[*] Lector 2. Suscrito");
            Console.WriteLine("[*] Lector 2. Esperando mensajes.");
            ...
            do
            {
                Console.WriteLine("[*] Lector 2. ¿Desea desuscribirse? [y,n] y presione enter en cualquier momento:");
                Console.WriteLine("[*] Ó [s] y presione enter en cualquier momento, para salir:");
                valorLeido = Console.ReadLine();
